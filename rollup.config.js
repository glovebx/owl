...
export default {
  ...
  output: [
    ...
    getConfigForFormat('amd', pkg.amd),
    getConfigForFormat('amd', pkg.amd, true),
    getConfigForFormat('umd', pkg.umd),
    getConfigForFormat('umd', pkg.umd, true),
    getConfigForFormat('system', pkg.system),
    getConfigForFormat('system', pkg.system, true),
  ],
  plugins: [
    typescript({
